...
def comparation(model1Path, model2Path, dataPath1, dataPath2, outputPath='Raports//comparation_dt2_sim//comparation.txt'):
...
def comparation_testData(model1Path, model2Path, outputPath='Raports//comparation_dt2_sim//comparation_test_data.txt'):
    model1 = joblib.load(model1Path)
    model2 = joblib.load(model2Path)
    ...
    truth1 = data['genre_simplified']
    truth2 = data['genre_simplified']
    cc = []
    cf = []
    fc = []
    ff = []
...
model_path1 = "Models\\data2_simplified\\logistic_regression_BoW.joblib"
model_path2 = "Models\\data2_simplified\\logistic_regression_TFIDF.joblib"
outh_path = 'Raports\\comparation_dt2_sim\\comparation_test_data.txt'
